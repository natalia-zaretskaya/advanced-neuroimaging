...
# Experiment adjustment example from 2025[^data-management-1]

[^data-management-1]: valid for PsychoPy v2024.2.4
...
-   Paradigm scheduling control

    -   Carryover counterbalancing - each condition is equally likely to be preceded by each other condition [@brooks2012] for block designs

    -   using neurodesign (see /shared/scripts/neurodesign.ipynb on neurodesk) event generation for event-related designs
...
See [Neurodesktop access – Visual Neuroscience Lab](https://visualneuroscience.github.io/neurodesk/neurodesktop.html)
...
dcm2niix -o $sortedFolder -r y $sourceFolder
...
![](images/clipboard-4281112599.png)
...
[MRI-Studies: General Information – Visual Neuroscience Lab](https://visualneuroscience.github.io/mri/MRI-Studies_general/mri-studies_general-information.html)

[Neurodesktop access – Visual Neuroscience Lab](https://visualneuroscience.github.io/neurodesk/neurodesktop.html)

[MRI: from DICOMs to GLM – Visual Neuroscience Lab](https://visualneuroscience.github.io/dicom_to_glm.html)

[01 - DICOM to BIDS – Visual Neuroscience Lab](https://visualneuroscience.github.io/dicom_to_glm/DICOMtoBIDS.html)
