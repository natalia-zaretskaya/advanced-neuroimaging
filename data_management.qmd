...
targetFolder=/home/jovyan/completion2/dcm_sorted
...
# run the script
./DICOMsort.sh $sourceFolder $targetFolder

# check the output of the target folder
ls -l $targetFolder

# run bidsmapper
bidsmapper $sourceFolder /home/jovyan/completion/bids

# once you are happy with the mapping, run bidscoiner
bidscoiner $sourceFolder /home/jovyan/completion/bids
```
...
![](images/clipboard-2244027224.png)

# Quality assurance

## MRIQC

### Used for quality assurance of large datasets
